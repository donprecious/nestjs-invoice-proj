...
export enum RolePermissions {
  create = 'Create_Role', //Post /api/scf/role
  list = 'List_All_Role', // Get /api​/scf​/role
  listOwnRole = 'List_Own_Role', // Get /api​/scf​/role/organization/{organizationId}
  delete = 'Delete_Role', //delete /api/scf/role
  view = 'View_Role', // view ​/api​/scf​/role/:roleId
  edit = 'Edit_Role', // put /api/scf/role
}

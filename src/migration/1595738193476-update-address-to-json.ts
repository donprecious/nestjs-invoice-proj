...
export class updateAddressToJson1595738193476 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `organization` ADD `bankcode` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `organization` DROP COLUMN `address`");
        await queryRunner.query("ALTER TABLE `organization` ADD `address` text NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `organization` DROP COLUMN `address`");
        await queryRunner.query("ALTER TABLE `organization` ADD `address` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `organization` DROP COLUMN `bankcode`");
        await queryRunner.query("ALTER TABLE `organization` ADD `bankname` varchar(255) NOT NULL");
